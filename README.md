...
* How employees are distributed across departments.
* How salaries differ between teams.
* Where there might be risks (like expiring contracts)
* How workload varies across departments.

  What the Dashboard Shows

The dashboard gives a quick overview of:

* Total number of employees and overall payroll.
* Average salary across the company.
* Department-wise employee distribution.
* Contracts that are about to end.
* Number of managers in each department.
* Average workload (projects per employee)
